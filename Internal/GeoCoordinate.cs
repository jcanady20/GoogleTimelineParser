    ...
    public class GeoCoordinate : IEquatable<GeoCoordinate>
    {
        ...
        public double Latitude
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Latitude", $"Argument must be in range of -90 to 90 value - {value}");
                }
                _latitude = value;
            }
        }
        ...
        public double Longitude
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Longitude", $"Argument must be in range of -180 to 180 - value {value}");
                }
                _longitude = value;
            }
        }
        ...
        public double Course
        {
            ...
            set
            {
                if (value < 0.0 || value > 360.0)
                    throw new ArgumentOutOfRangeException("course", $"Argument must be in range 0 to 360 - value {value}");
                _course = value;
            }
        }
